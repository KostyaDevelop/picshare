<template>
  <div class="posts-page">
    <div class="posts" v-for="(post, postNumber) in userPosts" :key="postNumber">
      <div class="post" :id="'post-' + post.photo_id">
        <div class="row">
          <div class="col-md-6">
            <div class="post-image" :id="'post-image' + post.photo_id">
          ...
          <div class="col-lg-6 col-md-6 col-sm-12">
            ...
            <div class="post-photo-comments" >
              <div class="post-photo-comments-content" >
                <div class="photo-comment" >
<!--                     v-for="(photoCom, photoComNumber) in photoComments" :key="photoComNumber"-->
<!--                >-->
...
<!--                      <img :src="photoCom.photoUserAvatar">-->
              ...
              <div class="post-photo-comments-input" >
    ...
    <div class="posts-empty empty-block" v-if="userPosts.length === 0">
      No Posts
    </div>
  </div>
</template>
...
export default {
  ...
  mounted () {
    axios
        .get('/get-user-posts' + this.$store.state.userID)
